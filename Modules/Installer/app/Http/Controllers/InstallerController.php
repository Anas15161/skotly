    ...
    public function __construct()
{
    ...
    // Skip purchase verification but allow other setup steps to proceed
    $this->middleware(function (Request $request, Closure $next) {
        // Directly skip purchase verification
        return $next($request);

        // Original code related to purchase verification (commented out)
        /*
