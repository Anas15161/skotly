                                    ...
                                    <div class="courses__item-content">
                                        <ul class="courses__item-meta list-wrap">
                                            <li class="courses__item-tag">
                                                <a href="{{ route('courses', ['category' => $course->category->id ?? null]) }}">
                                                    {{ $course->category->translation->name ?? 'Unknown Category' }}
                                                </a>
                                        ...
                                        <div class="courses__item-bottom">
                                            ...
                                            @elseif ($course->price > 0 && $course->discount > 0)
                                                <h5 class="price" style="font-size:18px">{{ currency($course->discount) }}</h5>
                                            @else
                                                <h5 class="price"style="font-size:18px">{{ currency($course->price) }}</h5>
                                            @endif --}}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="courses__item shine__animate-item">
                                    ...
                                    <div class="courses__item-content">
                                        <ul class="courses__item-meta list-wrap">
                                            <li class="courses__item-tag">
                                                @if ($course->category && $course->category->translation)
                                                    <a href="{{ route('courses', ['category' => $course->category->id]) }}">
