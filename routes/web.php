...
use App\Http\Controllers\Frontend\CoursSoutienController;
...
Route::group(['middleware' => 'maintenance.mode'], function () {
    ...
    Route::prefix('cours-soutien')->group(function () {
        Route::get('/', [CoursSoutienController::class, 'index'])->name('courssoutien');
